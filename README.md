...
Simple ruby program that build a school library using the oriented object approach.
The library keeps records of all the books and the students and teachers who borrowed them
...
Feel free to check the [issues page](https://github.com/AmineDerbal/school-library-ruby/issues).
